...
i32 errorNumber;     /* Run-time error number = 0 by default (ANSI) */

/* External objects */
extern i32 syntaxErrorNumber /* number of syntax errors reported by the parser */;
extern i32 line; /* source code line number - defined in scanner.c */
...
i64 getParserFileSize(String fname) {
	FILE* input;
	i64 flength;
	input = fopen(fname, "r");
	if (input == NULL) {
